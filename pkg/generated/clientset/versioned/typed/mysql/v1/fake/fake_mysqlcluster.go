...
func (c *FakeMySQLClusters) UpdateStatus(mySQLCluster *mysql_v1.MySQLCluster) (*mysql_v1.MySQLCluster, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(mysqlclustersResource, "status", c.ns, mySQLCluster), &mysql_v1.MySQLCluster{})
