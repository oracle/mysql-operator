...
func (c *FakeMySQLRestores) UpdateStatus(mySQLRestore *mysql_v1.MySQLRestore) (*mysql_v1.MySQLRestore, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(mysqlrestoresResource, "status", c.ns, mySQLRestore), &mysql_v1.MySQLRestore{})
