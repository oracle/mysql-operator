	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.MysqlV1().MySQLBackups(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MysqlV1().MySQLBackups(namespace).Watch(options)
			},
		},
		&mysql_v1.MySQLBackup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mySQLBackupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mysql_v1.MySQLBackup{}, f.defaultInformer)
}

func (f *mySQLBackupInformer) Lister() v1.MySQLBackupLister {
	return v1.NewMySQLBackupLister(f.Informer().GetIndexer())
}
