	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.MysqlV1().MySQLRestores(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MysqlV1().MySQLRestores(namespace).Watch(options)
			},
		},
		&mysql_v1.MySQLRestore{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mySQLRestoreInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mysql_v1.MySQLRestore{}, f.defaultInformer)
}

func (f *mySQLRestoreInformer) Lister() v1.MySQLRestoreLister {
	return v1.NewMySQLRestoreLister(f.Informer().GetIndexer())
}
