...
type MySQLClusterLister interface {
	...
	List(selector labels.Selector) (ret []*mysql.MySQLCluster, err error)
...
// List lists all MySQLClusters in the indexer.
func (s *mySQLClusterLister) List(selector labels.Selector) (ret []*mysql.MySQLCluster, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*mysql.MySQLCluster))
	})
	return ret, err
}
...
type MySQLClusterNamespaceLister interface {
	...
	Get(name string) (*mysql.MySQLCluster, error)
...
// List lists all MySQLClusters in the indexer for a given namespace.
func (s mySQLClusterNamespaceLister) List(selector labels.Selector) (ret []*mysql.MySQLCluster, err error) {
...
// Get retrieves the MySQLCluster from the indexer for a given namespace and name.
func (s mySQLClusterNamespaceLister) Get(name string) (*mysql.MySQLCluster, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(mysql.Resource("mysqlcluster"), name)
	}
	return obj.(*mysql.MySQLCluster), nil
}
